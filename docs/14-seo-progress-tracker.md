# HVACLogic — 30-Day SEO, Authority & Outreach Progress Tracker

> **Tracker Status**: Active Operational Ledger  
> **Version**: 1.0.0  
> **Start Date**: 2026-08-20  
> **Target Review Date**: 2026-09-20  
> **Canonical Domain**: `https://hvaclogic.org`  
> **Related Docs**: [13-30-day-seo-authority-plan.md](./13-30-day-seo-authority-plan.md), [07-master-seo-strategy.md](./07-master-seo-strategy.md), [11-analytics-and-kpi-plan.md](./11-analytics-and-kpi-plan.md)
...
- [ ] **Day 16**: **Daily Touches 1–3**: Solve 1 live friction question on *HVAC-Talk*, email Vocational Tech College #1, submit profile to *AlternativeTo*.
- [ ] **Day 17**: **Daily Touches 4–6**: Answer 1 diagnostic thread on `r/HVAC`, email Community College HVAC Dept #1, pitch *HVAC School (Bryan Orr)* with an interactive superheat worked example.
- [ ] **Day 18**: **Daily Touches 7–9**: Answer 1 Manual J thread on `r/MEPEngineering`, email Union JATC Apprentice Coordinator #1, pitch *ACHR News* editorial desk.
- [ ] **Day 19**: **Daily Touches 10–12**: Answer 1 tonnage decode question on `r/hvacadvice`, email Vocational Tech College #2, contact Green Building technical blogger.
- [ ] **Day 20**: **Daily Touches 13–15**: Answer 1 A2L refrigerant question on `r/refrigeration`, email Community College HVAC Dept #2, pitch *Contracting Business* editor.
- [ ] **Day 21**: **Weekly Review**: Log all responses, track reply rates, and publish source methodology links in all email follow-ups.

### Week 4 — Performance Review, Evidence Iteration & Month 2 Backlog
- [ ] **Day 22**: Export Google Search Console Page Indexing, Sitemap status, and Performance reports. Log initial organic impressions and query terms.
- [ ] **Day 23**: Analyze search impressions and average positions. Identify high-impression queries in positions 4–20 for snippet refinements.
- [ ] **Day 24**: Add user-requested secondary units, boundary notes, or edge-case definitions to existing tools based on real search query evidence.
- [ ] **Day 25**: Perform manual SERP and AI visibility audit across 8 core problem statements. Record citation sources and competitor gaps.
- [ ] **Day 26**: Complete quality, metadata, and formula review for Tier 2 calculators (`furnace-size`, `mini-split`, `heat-pump`, `filter-sizing`).
- [ ] **Day 27**: Send 1 gentle, value-added follow-up email to non-responders from Days 16–20 including the printable student lab sheet demo.
- [ ] **Day 28**: Audit newly acquired backlinks, brand mentions, and referring domains in Search Console / Bing.
- [ ] **Day 29**: Re-run Core Web Vitals audit and production Lighthouse suite to guarantee zero performance regression.
- [ ] **Day 30**: Conduct Month 1 Final Review with stakeholders. Document verified results, baseline changes, and prioritize Month 2 roadmap.

---

## 2. Active Outreach CRM & Backlink Acquisition Pipeline (40 Targets)
...
## 3. Daily 2–3 Touches Community Posting & Value Ledger

| Date | Platform / Community | Thread Topic / Target Discussion | Value-First Mathematical Proof / Solution Provided | Calculator Permalink Linked | Upvotes / Replies |
| :---: | :--- | :--- | :--- | :--- | :---: |
...
## 4. Academic Whitepaper Citation & Indexation Register
...
## 6. Core Web Vitals & Synthetic Performance Baseline
