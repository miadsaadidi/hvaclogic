...
export const calculatorRegistry: CalculatorMeta[] = [
  ...
  },
  {
    ...
    primaryIntent: "Transactional / Professional Engineering",
    seoTitle: "Duct Friction Loss & TEL Sizer: Manual D | HVACLogic",
  ...
  },
  {
    ...
    seoTitle: "AC Model Number Decoder — Tonnage & SEER | HVACLogic",
  ...
  },
  {
    ...
    primaryIntent: "Navigational / Field Lookup",
    seoTitle: "Refrigerant PT Chart (2026): R-454B & R-32 | HVACLogic",
