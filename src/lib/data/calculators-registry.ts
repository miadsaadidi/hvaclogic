...
export const calculatorRegistry: CalculatorMeta[] = [
  ...
  // -------------------------------------------------------------
  {
    ...
    relatedCalculatorIds: ["duct-friction-loss-calculator", "flex-duct-cfm-chart", "cfm-calculator", "filter-sizing-calculator"],
  ...
  },
  {
    ...
    metaDescription: "Flexible duct CFM sizing chart for 4\" to 20\" round ducts. Compare airflow across 0.05\" to 0.15\" WG friction rates with ASHRAE RP-1333 sag deratings.",
    categoryName: "Airflow & Ducts",
    categoryRoute: "/airflow-ducts",
    features: [
    ...
    relatedCalculatorIds: ["ductulator", "cfm-calculator", "duct-friction-loss-calculator"],
    researchSlug: "non-linear-duct-friction-loss-fitting-penalties",
  ...
  },
  {
    ...
    relatedCalculatorIds: ["ductulator", "filter-sizing-calculator", "flex-duct-cfm-chart", "cfm-calculator"],
    researchSlug: "non-linear-duct-friction-loss-fitting-penalties",
    oerModuleUrl: "/oer-modules/duct-aerodynamics-lab.html",
  ...
  },
  {
    ...
    seoTitle: "AC Tonnage Calculator & Cooling Capacity Sizer",
  ...
  },
  {
    ...
    metaDescription: "Decode Carrier, Trane, Lennox, Goodman, Rheem & Daikin model numbers. Find nominal AC tonnage, BTU capacity, design airflow CFM, and manufacture year.",
    categoryName: "Cooling & Loads",
    categoryRoute: "/cooling-loads",
    features: [
  ...
  },
  {
    ...
    seoTitle: "Mini-Split Sizing — Multi-Zone Inverter",
  ...
  // -------------------------------------------------------------
  {
    ...
    seoTitle: "Superheat & Subcooling Charging Sizer",
  ...
  },
  {
    ...
    secondaryKeywords: ["454b pt chart", "r32 pt chart", "refrigerant pt chart", "a2l refrigerant pressure chart", "454b pressure temperature chart", "r454b pressure temp chart", "r410a pt chart"],
    primaryIntent: "Navigational / Field Lookup",
    seoTitle: "R-454B, R-32 & A2L Pressure-Temperature (PT) Chart",
    metaDescription: "Interactive digital Pressure-Temperature chart for R-454B, R-32, R-410A, R-22, and zeotropic blends. Instant bubble and dew point saturation calculations.",
    categoryName: "Field Diagnostics",
    categoryRoute: "/field-diagnostics",
    features: [
  ...
  },
  {
    ...
    seoTitle: "Psychrometric Chart & Moist Air Sizer",
  ...
  },
  {
    ...
    seoTitle: "Refrigerant Line Set Charge Calculator",
  ...
  // -------------------------------------------------------------
  {
    ...
    relatedCalculatorIds: ["heat-loss-calculator", "furnace-size-calculator", "btu-calculator", "ac-tonnage-calculator"],
  ...
  },
  {
    ...
    seoTitle: "Furnace Sizing Calculator — AFUE & BTU",
    ...
    relatedCalculatorIds: ["heat-loss-calculator", "heat-pump-size-calculator", "combustion-air-calculator", "boiler-size-calculator"],
  ...
  },
  {
    ...
    seoTitle: "Boiler Sizing Calculator — Baseboard & EDR",
    ...
    relatedCalculatorIds: ["heat-loss-calculator", "furnace-size-calculator", "combustion-air-calculator"],
  ...
  },
  {
    ...
    researchSlug: "effective-dilution-iaq-ventilation-mass-balance",
    datasetSlug: "combustion-air-confined-space",
    datasetUrl: "/datasets/combustion_air_and_confined_space_benchmark_2026.csv",
  ...
  // -------------------------------------------------------------
  {
    ...
    relatedCalculatorIds: ["heat-loss-calculator", "btu-calculator", "garage-heater-sizing"],
    researchSlug: "student-lab-building-envelope-thermal-transmission",
    oerModuleUrl: "/oer-modules/building-envelope-thermal-transmission-lab.html",
    datasetUrl: "/datasets/building_envelope_thermal_transmission_benchmark_dataset_2026.csv",
  ...
  },
  {
    ...
    seoTitle: "Building Heat Loss & Infiltration Sizer",
