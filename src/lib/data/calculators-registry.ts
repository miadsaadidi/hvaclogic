...
export const calculatorRegistry: CalculatorMeta[] = [
  ...
  },
  {
    ...
    relatedCalculatorIds: ["ductulator", "duct-friction-loss-calculator", "cfm-calculator", "filter-sizing-calculator"],
    researchSlug: "non-linear-duct-friction-loss-fitting-penalties",
  ...
  },
  {
    ...
    secondaryKeywords: ["how to find ac tonnage", "carrier nomenclature tonnage", "carrier tonnage by model number", "trane model number tonnage", "lennox ac tonnage by model number", "ac model decoder"],
    primaryIntent: "High Commercial / Nameplate Decoder",
    seoTitle: "AC Model Number Decoder — Tonnage & SEER",
    metaDescription: "Decode Carrier, Trane, Lennox, Goodman, Rheem, Daikin & ICP model numbers. Instant nominal tonnage, SEER rating, manufacture year, and CFM airflow.",
    categoryName: "Cooling & Loads",
    categoryRoute: "/cooling-loads",
    features: [
    ...
    relatedCalculatorIds: ["ac-tonnage-calculator", "refrigerant-charge-calculator", "superheat-subcooling-calculator"],
    standards: ["AHRI"],
    formulaVersion: "1.0.0",
    dataVersion: "1.0.0",
    lastEngineeringReview: "2026-08-19",
